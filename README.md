...
- ⚙️ **PHP / Laravel** application development
- 🔗 REST API integrations and custom functionality
- 🤖 Automations and platform-specific solutions
...
**Also working with:**  
`Eloquent ORM` · `Blade` · `AJAX` · `JSON` · `WordPress Hooks & Filters` · `Custom Post Types` · `ACF` · `SSH / CLI` · `Artisan` · `Tinker`

---

## 🚀 Production Portfolio

I've worked on **20+ completed production websites and e-commerce projects** across multiple industries.

### 🛒 E-commerce & Digital Platforms

- 📚 [Atelierul de Sine](https://atelieruldesine.ro/)
- 🏠 [nZEBexpert](https://nzebexpert.ro/)
- 🛒 [MOBSOP](https://mobsop.ro/)
- 🎨 [Vernisage](https://vernisage.ro/)
- 🛍️ [Irevelato](https://irevelato.com/)
- 🎨 [WOW Art](https://wowart.ro/)
- 🌿 [Wellness Laghetto](https://wellnesslaghetto.com/)
- 🛒 [Lito](https://lito.ro/)
...
- 🏥 [Pharmvision](https://pharmvision.ro/)

### 👤 Personal Brands & Content Platforms

- ✍️ [Lumeria](https://lumeria.ro/)
